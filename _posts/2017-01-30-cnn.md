...
{% include image.html img="images/2017/cnn/comparing-regular-and-cnn2.jpeg" title="Convolutional Neural Net" caption="Every layer of a ConvNet transforms the 3D input volume to a 3D output volume of neuron activations. In this example, the red input layer holds the image, so its width and height would be the dimensions of the image, and the depth would be `3` (Red, Green, Blue channels)." url="http://ioarun.github.io/images/2017/cnn/comparing-regular-and-cnn2.jpeg" %}
...
{% include image.html img="images/2017/cnn/Convolution_schematic.gif" title="convolution" caption="Convolution operation - elementwise multiplication and then adding the results" url="http://ioarun.github.io/images/2017/cnn/Convolution_schematic.gif" %}
...
{% include image.html img="images/2017/cnn/neurons-in-conv.jpeg" title="Convolution layer" caption="A 32x32x3 volume input connected to a neuron in convolutional layer" url="http://ioarun.github.io/images/2017/cnn/neurons-in-conv.jpeg"  %}
...
{% include image.html img="images/2017/cnn/padding.png" title="Padding" caption="Padding helps maintain the output dimension(spatially)" url="http://ioarun.github.io/images/2017/cnn/padding.png" %}
...
output volume of size [112x112x64]" url="http://ioarun.github.io/images/2017/cnn/downsampling.jpeg" %}
...
{% include image.html img="images/2017/cnn/fc-cnn.jpeg" title="Fully connected layer" caption="" url="http://ioarun.github.io/images/2017/cnn/fc-cnn.jpeg" %}
...
{% include image.html img="images/2017/cnn/cnn-title-image.jpeg" title="LeNet" caption="LeNet-5[LeCun et al., 1998] had CONV-POOL-CONV-POOL-CONV-FC architecture" url="http://ioarun.github.io/images/2017/cnn/cnn-title-image.jpeg" %}
